...
- Les captures patrimoniales viennent de la commande manuelle ou de `pnpm snapshot --portfolio <uuid> --daily`, à planifier séparément. Une capture quotidienne reste unique par journée locale, même après une nouvelle observation et même avec deux jobs concurrents.
